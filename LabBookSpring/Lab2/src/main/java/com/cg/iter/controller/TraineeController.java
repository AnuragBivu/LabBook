...
public class TraineeController {
	...
	public String addtrainee(Model model,@ModelAttribute("trainee") Trainee trainee) {
	    try {     
	    	service.create(trainee);
	         model.addAttribute("msg","Trainee "+trainee.getTraineeName()+" added successfully!");
	...
	public String deleteById(Model model,@RequestParam("deleteId") int traineeid) {
		model.addAttribute("list",this.service.find(traineeid));
		return "deletetrainee";
	}
	@RequestMapping(value="/deletetrainee/{id}",method=RequestMethod.POST)
	public String delete(Model model,@PathVariable("id") int traineeid) {
	...
	//Modify Operation 
		...
		public String modifyById(Model model,@RequestParam("modifyId") int traineeid) {
			model.addAttribute("list",this.service.find(traineeid));
			return "modifytrainee";
		}
	...
	public String retrievebyid(Model model,@RequestParam("retrieveId") int traineeid ) {
